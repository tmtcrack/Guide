...
dbzabbix="SML@1983zxcv"

# MySQL database monitoring user
monzabbix="SML@1983zxcv"

# Zabbix Server URL
zabbixurl="https://cdn.zabbix.com/zabbix/sources/stable/6.0/zabbix-6.0.9.tar.gz"
...
ALTER USER 'root'@'%' IDENTIFIED WITH mysql_native_password BY '${dbroot}';
GRANT ALL PRIVILEGES ON zabbix.* TO 'root'@'%';
